...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Entity\\dai\\rh\\EmployeeFormType' => function () {
    return ${($_ = isset($this->services['employeeformtype_entitymanager.service']) ? $this->services['employeeformtype_entitymanager.service'] : $this->load('getEmployeeformtypeEntitymanager_ServiceService.php')) && false ?: '_'};
