...
class __TwigTemplate_9918bf95dc2daa258a1c9d59d0990cef64a94eec8ef5f4fe0dc5bd593d012353 extends Twig_Template
{
    private $source;
...
<div class=\"fos_user_user_show\">
    ...
    ";
        // line 7
        if ( !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 7, $this->source); })()), "user", array()), "lotacao", array()))) {
            // line 8
            echo "        <p>Lotação: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 8, $this->source); })()), "lotacao", array()), "descricao", array()), "html", null, true);
            echo "</p>
    ";
        }
        // line 10
...
";
    ...
    {
        return array (  58 => 11,  53 => 10,  47 => 8,  45 => 7,  41 => 6,  37 => 5,  33 => 4,  29 => 2,);
    }
...
", "@FOSUser/Profile/show_content.html.twig", "C:\\Bitnami\\wampstack-7.0.28-0\\frameworks\\omnia\\src\\Resources\\FOSUserBundle\\views\\Profile\\show_content.html.twig");
    }
}
