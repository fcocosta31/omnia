...
namespace Proxies\__CG__\App\Entity\dti;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class TipoEquipamento extends \App\Entity\dti\TipoEquipamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'descricao', 'equipamentos'];
        }
